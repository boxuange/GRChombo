...
// Class which creates Oscillotons (A selfgravitating scalar field) using external data-files.
// Information taken form gr-qc/0301105 - Numerical sutdies of Phi^2 Oscillotons
class Oscilloton {
 public:
    ...
    struct params_t {
        ...
        std::array<double, CH_SPACEDIM> centerSF2; // Centre of perturbation in initial SF bubble
  ...
  protected:
    ...
    int m_row_max; //Maximum rows in our arrays (Sorry Katy for using arrays and not tensors!)
    int m_column_max; //Maximum columns in our arrays (notice that phi has m_column_max-1)
    ...
    // To input the components of a, c and phi (and there respective derivatives) into the
    // linear Interpolator we need them to be a 1D array

    // a, c and phi components
    double a_rad[m_file_length],a0[m_file_length],a2[m_file_length],a4[m_file_length],a6[m_file_length],a8[m_file_length],a10[m_file_length],a12[m_file_length];
    double c_rad[m_file_length],c0[m_file_length],c2[m_file_length],c4[m_file_length],c6[m_file_length],c8[m_file_length],c10[m_file_length],c12[m_file_length];
    double phi_rad[m_file_length],phi1[m_file_length],phi3[m_file_length],phi5[m_file_length],phi7[m_file_length],phi9[m_file_length],phi11[m_file_length];

    // a, c and phi radial derivatives
    double d_a_rad_dr[m_file_length],d_a0_dr[m_file_length], d_a2_dr[m_file_length], d_a4_dr[m_file_length], d_a6_dr[m_file_length], d_a8_dr[m_file_length], d_a10_dr[m_file_length], d_a12_dr[m_file_length];
    double d_c_rad_dr[m_file_length],d_c0_dr[m_file_length], d_c2_dr[m_file_length], d_c4_dr[m_file_length], d_c6_dr[m_file_length], d_c8_dr[m_file_length], d_c10_dr[m_file_length], d_c12_dr[m_file_length];
